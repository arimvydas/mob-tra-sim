...
| Xu'17  | Twenty-four hour daily traffic for average day, weekly evolutions for each day of the week and weekly data for different areas: residential, office, transport and entertainment | Throughput (Bytes/10min) and normalized units | [Xu'17](https://ieeexplore.ieee.org/document/7762185) |
